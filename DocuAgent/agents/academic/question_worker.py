...
# Import CRAG utility
from DocuAgent.utils.CRAG import build_CorrectiveRetriever
...
class QuestionWorkerGraph:
    ...
    def _generate_one(
        ...
        try:
            ...
            img_res = requests.get(img_url, headers=settings.DOWNLOAD_HEADERS, timeout=15)
    ...
    def _is_url_accessible(self, url: str) -> bool:
        ...
        try:
            resp = requests.head(
                url, headers=settings.DOWNLOAD_HEADERS, timeout=5, allow_redirects=True
            )
